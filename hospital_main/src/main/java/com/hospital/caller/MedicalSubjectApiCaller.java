...
public class MedicalSubjectApiCaller {
    ...
    public MedicalSubjectApiCaller(RestTemplate restTemplate, ObjectMapper objectMapper) {
    ...
    public MedicalSubjectApiResponse callApi(String queryParams) {
        ...
        try {
            ...
            // JSON 파싱
            MedicalSubjectApiResponse apiResponseDto = objectMapper.readValue(responseJson, MedicalSubjectApiResponse.class);
